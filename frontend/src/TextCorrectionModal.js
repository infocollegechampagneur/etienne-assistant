...
const TextCorrectionModal = ({ open, onClose, onSubmit, apiUrl }) => {
  ...
  const handleSubmit = () => {
    ...
    message += `\n**Format du tableau de corrections:** ${tableauFormat === 'type' ? 'Option 2 — Par TYPE de faute (regrouper les erreurs par catégorie: S, P, U, G, V, C1, C2)' : 'Option 1 — Par NUMÉRO (ordre d\'apparition dans le texte)'}\n`;
            ...
            <div className="flex gap-3">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Fautes dans l'ordre d'apparition dans le texte</p>
                </div>
              </label>
              <label 
                className={`flex items-center gap-2 px-4 py-2.5 rounded-lg border cursor-pointer transition-all ${
              ...
              >
                ...
                />
                <div>
                  <span className="text-sm font-medium text-gray-800">Par type de faute</span>
                  <p className="text-xs text-gray-500">Fautes regroupées par catégorie (S, P, U, G, V...)</p>
                </div>
              </label>
            </div>
          </div>
