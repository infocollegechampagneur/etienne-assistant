      ...
      <div className="max-w-6xl mx-auto px-4 pb-8">
        ...
        {!currentUser ? (
          ...
          <div className={isChatFullscreen ? "fixed inset-0 z-50 bg-white p-4 overflow-auto" : "lg:col-span-3 relative"}>
            {/* Bouton plein écran - position fixe en mode fullscreen */}
            {isChatFullscreen && (
              <Button
                variant="outline"
                size="sm"
                onClick={() => setIsChatFullscreen(false)}
                className="fixed top-4 right-4 z-[60] bg-orange-500 hover:bg-orange-600 text-white shadow-lg"
              >
              ...
              <CardHeader className="pb-2 relative">
                ...
                {!isChatFullscreen && (
                  <Button
                    ...
                    className="absolute top-2 right-2 z-10 bg-white hover:bg-orange-50 border-orange-200"
                  >
...
const ProfileModal = ({ onClose, API, onEmailChanged }) => {
  ...
  useEffect(() => {
    // Récupérer l'email actuel du token
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <div className="mb-6 p-4 bg-gray-50 rounded-lg">
            ...
            <p className="font-semibold text-lg">{currentEmail}</p>
          </div>
