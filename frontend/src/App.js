                              ...
                              <div className={`rounded-2xl px-4 py-3 ${msg.isUser 
                                ...
                                {!msg.isUser && msg.can_download && (
                                  <div className="mt-3 pt-2 border-t border-gray-200">
                                    {/* Détection correction MEQ — offrir options de contenu */}
                                    {(() => {
                                          ...
                                          <>
                                            ...
                                            <div className="flex flex-col gap-2">
                                              <div className="flex gap-1 flex-wrap">
                                                ...
                                                <button
                                                  onClick={() => downloadDocument(msg.message, 'Correction Étienne', 'pdf')}
                                                  className="text-xs bg-red-100 hover:bg-red-200 text-red-700 px-2 py-1 rounded transition-colors"
                                                >📄 PDF</button>
                                                <button
                                                  onClick={() => downloadDocument(msg.message, 'Correction Étienne', 'docx')}
