      ...
      <div className="max-w-6xl mx-auto px-4 pb-8">
        ...
        {!currentUser ? (
          ...
          <div className={isChatFullscreen ? "fixed inset-0 z-50 bg-white p-4 overflow-auto" : "lg:col-span-3 relative"}>
            {/* Boutons en position fixe en mode fullscreen */}
            {isChatFullscreen && (
              <div className="fixed top-4 right-4 z-[60] flex gap-2">
                {/* Bouton Imprimer - fullscreen */}
                <Button
                  variant="outline"
                  size="sm"
                  onClick={handlePrintChat}
                  className="bg-white hover:bg-blue-50 border-blue-200 shadow-lg"
