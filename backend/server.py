            ...
            if file_extension == 'pdf':
                ...
                try:
                    ...
                    response = model.generate_content(
                        [
                            "Tu es un expert en transcription de textes MANUSCRITS et imprimés. "
                            "Extrais TOUT le texte visible dans cette image (photo, scan ou document numérisé). "
                            "Si le texte est écrit à la MAIN : déchiffre soigneusement chaque mot, même si "
                            "l'écriture est difficile (lettres attachées, ratures, écriture d'élève). "
                            "RÈGLES STRICTES : "
                            "1) Transcris le texte TEL QUEL, en conservant TOUTES les fautes d'orthographe, "
                            "de grammaire et de ponctuation de l'élève — NE CORRIGE RIEN. "
                            "2) Respecte la mise en page originale (paragraphes, retours à la ligne). "
                            "3) Si un mot est vraiment illisible, écris [illisible]. "
                            "4) Ignore les ratures/mots barrés par l'élève. "
                            "5) Retourne UNIQUEMENT le texte brut, sans commentaire ni explication.",
                            img
                        ]
                    )
