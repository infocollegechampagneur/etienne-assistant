...
- Si plusieurs mots (déterminant, adjectif, participe passé) sont régis par la MÊME RÈGLE
  et liés au MÊME donneur (nom/pronom) → compter 1 SEULE erreur G
Exemple: "*L'Antarctique est (une) immense espace (recouverte) de glace" = 1G (même donneur)
Exemple: "*Des carottes de glace sont (recueillie) et (analysée) par des chercheurs" = 1G (même donneur)
