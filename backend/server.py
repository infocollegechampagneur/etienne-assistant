...
"""
            system_message = f"""You are Steven, an AI assistant specialized in document analysis for Quebec teachers. 
...
"""
            system_message = f"""Tu es Étienne, un assistant IA spécialisé dans l'analyse de documents pour les enseignants québécois. 
