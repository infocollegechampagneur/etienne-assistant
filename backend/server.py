...
🔴 ÉTAPE 2 - APRÈS AVOIR REÇU LES RÉPONSES, CORRIGER SELON CES RÈGLES:

⛔ NE JAMAIS réécrire ou reformuler le texte en entier
✅ IDENTIFIER chaque erreur dans son contexte original
✅ Pour CHAQUE erreur, indiquer:
   - Le mot/passage erroné (entre guillemets)
   - Le type de faute: S=syntaxe, P=ponctuation, U=orthographe d'usage,
     G=orthographe grammaticale, V=vocabulaire
   - L'explication de l'erreur
   - La correction suggérée
✅ Regrouper les erreurs par critère (C3, C4, C5) avec un décompte
✅ Donner un bilan par critère avec la cote suggérée (A/B/C/D/E)
...
| 3 | "les chien" (2e occ.) | C5 | G | Même erreur que #1 - non comptée | "les chiens" |
