...
try:
    ...
    def detect_angle_request(message: str) -> str:
        ...
        # Patterns pour détecter les demandes d'angles
        if any(word in message_lower for word in ['angle adjacent', 'angles adjacents']):
            return 'adjacents'
        elif any(word in message_lower for word in ['complémentaire', 'complementaire', 'angle complémentaire']):
            return 'complementaires'
        elif any(word in message_lower for word in ['supplémentaire', 'supplementaire', 'angle supplémentaire']):
            return 'supplementaires'
        elif any(word in message_lower for word in ['opposé par le sommet', 'opposés par le sommet', 'oppose par le sommet']):
            return 'opposes_sommet'
        elif any(word in message_lower for word in ['alterne-interne', 'alternes-internes', 'alterne interne', 'alternes internes']):
            return 'alternes_internes'
        elif any(word in message_lower for word in ['alterne-externe', 'alternes-externes', 'alterne externe', 'alternes externes']):
            return 'alternes_externes'
        elif any(word in message_lower for word in ['correspondant', 'correspondants', 'angle correspondant']):
